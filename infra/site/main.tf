...
resource "aws_cloudfront_origin_access_control" "site" {
  ...
  description                       = "Private S3 access for archunit.net"
...
resource "aws_cloudfront_function" "rewrite" {
  ...
  comment = "Map clean Astro routes to their generated index.html objects"
  publish = true
